      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <Link
              href="/services"
              className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-gray-700 bg-white border-2 border-gray-200 rounded-full transition-all duration-300 hover:border-blue-300 hover:text-blue-600 hover:shadow-lg hover:-translate-y-1 min-w-[200px]"
            >
              View Services
            </Link>
          </div>
          ...
          <div className="pt-12">
            ...
            <div className="flex justify-center items-center space-x-8 opacity-60">
              ...
              <div className="text-gray-600 font-medium">10k+ Happy Customers</div>
