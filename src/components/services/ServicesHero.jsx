...
const useServicesData = () => useMemo(() => ([
  ...
  // Driver Services
  { id: 30, name: 'Full-Day Personal Driver', category: 'driver', price: 1000, duration: '10 hrs included', rating: 4.9, reviews: 512, image: 'https://images.unsplash.com/photo-1483721310020-03333e577078?auto=format&fit=crop&w=800&q=80', description: 'Hire a verified personal driver for full-day city commutes with transparent overtime billing.', badge: 'Premium', driverConfig: { baseHours: 10, hourlyRate: 100, overtimeMultiplier: 2 } },
  { id: 31, name: 'Outstation Driving Service', category: 'driver', price: 1600, duration: '12 hrs included', rating: 4.8, reviews: 341, image: 'https://images.unsplash.com/photo-1517142089942-ba376ce32a2e?auto=format&fit=crop&w=800&q=80', description: 'Experienced highway drivers for weekend getaways or business trips outside the city. Night halt friendly.', driverConfig: { baseHours: 12, hourlyRate: 130, overtimeMultiplier: 1.75 } },
