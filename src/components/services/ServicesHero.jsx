...
const useServicesData = () => useMemo(() => ([
  ...
  { id: 32, name: 'Bhoomi Poojan', category: 'pujari', price: 3500, duration: '2-3 hours', rating: 0, reviews: 0, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop', description: 'Ground breaking ceremony before construction with Vastu rituals for successful project completion', noPartner: true },
  { id: 33, name: 'Vaahan Poojan', category: 'pujari', price: 1500, duration: '1 hour', rating: 0, reviews: 0, image: 'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=400&h=300&fit=crop', description: 'Vehicle blessing ceremony for new car, bike, or any vehicle for safe travels and protection', noPartner: true },
  { id: 34, name: 'Shraadh Karm', category: 'pujari', price: 3000, duration: '2-3 hours', rating: 0, reviews: 0, image: 'https://images.unsplash.com/photo-1609619385002-f40f5c30f8bc?w=400&h=300&fit=crop', description: 'Sacred ritual to honor and pay respects to departed ancestors during Pitru Paksha', noPartner: true },
  { id: 35, name: 'Janmadin Poojan', category: 'pujari', price: 2000, duration: '1-2 hours', rating: 0, reviews: 0, image: 'https://images.unsplash.com/photo-1464349153735-7db50ed83c84?w=400&h=300&fit=crop', description: 'Birthday blessing ceremony with special puja, havan, and mantras for long life and prosperity', noPartner: true },
  { id: 36, name: 'Sundarkand Path', category: 'pujari', price: 2800, duration: '3-4 hours', rating: 0, reviews: 0, image: 'https://images.unsplash.com/photo-1609619385002-f40f5c30f8bc?w=400&h=300&fit=crop', description: 'Recitation of Sundarkand from Ramcharitmanas for removing obstacles and bringing success', noPartner: true },
...
const ServiceCard = ({ service, onBook, isFavorite, onToggleFavorite, isLoggedIn, startingPrice, providerCount }) => {
  ...
  // Check if service has no partner yet - dynamic check based on API data
  // If API returned provider count, use that; otherwise fall back to static noPartner flag
  const hasNoPartner = fetchAttempted 
    ? (effectiveProviderCount === 0 && service.noPartner === true)
    : service.noPartner === true;
        ...
        {isLoggedIn ? (
          ...
          <>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                {hasNoPartner ? 'Coming Soon' : isActive ? 'Login to Book' : 'Coming Soon'}
              </button>
            </div>
          </>
        )}
