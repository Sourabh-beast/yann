                ...
                <div className="mb-6">
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {/* License Images + Police Verification */}
                      {(selectedProvider.driverServiceDetails.licenseFrontImage || selectedProvider.driverServiceDetails.licenseBackImage || selectedProvider.driverServiceDetails.policeVerificationDoc) && (
                        <div className="col-span-1 md:col-span-2 mt-2">
                          <p className="text-xs text-gray-500 mb-2 font-medium">Driver Documents</p>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            {selectedProvider.driverServiceDetails.policeVerificationDoc && (
                              <div className="bg-white p-2 rounded-lg shadow-sm border border-gray-100">
                                <p className="text-xs font-semibold text-gray-400 mb-1 uppercase text-center tracking-wider">Police Verification</p>
                                <img src={selectedProvider.driverServiceDetails.policeVerificationDoc} alt="Police Verification" className="w-full h-32 object-cover rounded border border-gray-200" />
                              </div>
                            )}
                          </div>
                        </div>
