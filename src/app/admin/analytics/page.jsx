...
import {
  Activity, Users, Briefcase, ClipboardList,
  TrendingUp, TrendingDown, DollarSign, Package,
  BarChart3, Download, Star, ArrowUp, ArrowDown, Minus
} from 'lucide-react';
                        ...
                        {data.services.map((service, idx) => (
                          <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td className="py-3 px-4 text-right">
                              <span className={`px-2 py-1 rounded-full text-xs ${parseFloat(service.completionRate) >= 80 ? 'bg-green-100 text-green-700' :
                        ...
                        {data.topProviders.map((provider, idx) => (
                          <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                            <td className="py-3 px-4">
                              <span className={`w-8 h-8 flex items-center justify-center rounded-full text-white font-bold ${idx === 0 ? 'bg-yellow-500' : idx === 1 ? 'bg-gray-400' : idx === 2 ? 'bg-orange-400' : 'bg-gray-300'
                                }`}>
                                {idx + 1}
                              </span>
                            </td>
  ...
  return (
    <div className="p-4 bg-gray-50 rounded-xl">
      ...
      <div className="flex items-end justify-between">
        ...
        <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-sm font-medium ${isNeutral ? 'bg-gray-100 text-gray-600' :
